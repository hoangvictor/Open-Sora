...
@SCHEDULERS.register_module("rflow", force=True)
class RFLOW:
    def __init__(
        self,
        ...
        if is_profiling:
            ...
            with profile(
                ...
                for i, t in progress_wrap(enumerate(timesteps)):
                    ...
                    # update z
                    dt = (
                        timesteps[i] - timesteps[i + 1] if i < len(timesteps) - 1 else timesteps[i]
                    )
    ...
    def __repr__(self):
        return "RFLOW(num_sampling_steps={}, num_timesteps={}, cfg_scale={}, use_discrete_timesteps={}, use_timestep_transform={})".format(
